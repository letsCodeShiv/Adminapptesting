...
const FirstCard = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      Header: () => (
        <>
          <span data-tooltip-id="value_tooltip">VALUE</span>
          <ReactTooltip
            id="value_tooltip"
            place="bottom"
    ...
    },
    {
      Header: () => (
        <>
          <span data-tooltip-id="trend_tooltip_first">TREND</span>
          <ReactTooltip
            id="trend_tooltip_first"
            place="bottom"
            ...
            <FalconComponentCard noGuttersBottom>
              <Card className="h-100 mt-2">
                <Row className="g-2">
                  <Col md={6}>
                    <Dropdown
                      data-tooltip-id="kpi_tooltip_first"
                      value={selectedKPIs}
                      options={kpiList}
                      optionLabel="label"
