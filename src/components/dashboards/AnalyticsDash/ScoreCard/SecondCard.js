...
const SecondCard = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      Header: () => (
        <>
          <span data-tooltip-id="value_tooltip_second">VALUE</span>
          <ReactTooltip
            id="value_tooltip_second"
            place="bottom"
  ...
  const handleDropdownBlur = () => {
    setTimeout(() => {
      setShowTooltip(true);
    }, 100); // Add a small delay to allow for dropdown closing animation
  };
  return (
    <div>
          ...
          <FalconComponentCard noGuttersBottom>
            <Card className="h-100 mt-2">
              <Row className="g-2">
                <Col md={6}>
                  <Dropdown
                    data-tooltip-id="kpi_tooltip_second"
                    value={selectedKPIs}
                    options={kpiList}
                    optionLabel="label"
