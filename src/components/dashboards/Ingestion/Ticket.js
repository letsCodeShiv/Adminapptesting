...
import { Row, Col, Tab, Tabs, Card, ProgressBar } from "react-bootstrap";
                        ...
                        <Col sm={3}>
                          <Card className="h-100">
                            <Card.Body>
                              ...
                              <p className="fs--1 text-800">Under Process</p>
                        ...
                        <Col sm={3}>
                          <Card className="h-100">
                            <Card.Body>
                              ...
                              <p className="fs--1 text-800">Not Started</p>
                        ...
                        <Col sm={3}>
                          <Card className="h-100">
                            <Card.Body>
                              ...
                              <p className="fs--1 text-800">Error</p>
